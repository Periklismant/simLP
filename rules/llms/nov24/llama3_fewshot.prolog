...
holdsFor(pilotOps(PilotVessel, Vessel)=true, I) :-
    ...
    not holdsFor(withinArea(PilotVessel, nearCoast)=true, I6),
    not holdsFor(withinArea(Vessel, nearCoast)=true, I7),
...
holdsFor(loitering(Vessel)=true, I) :-
    ...
    not holdsFor(withinArea(Vessel, nearCoast)=true, I3),
    not holdsFor(anchoredOrMoored(Vessel)=true, I4),
