...
Note that the definitions of rendezVous, underWay, movingSpeed, changingSpeed and drifting are not included in either file:
- rendezVous is used as an example in our prompting method.
